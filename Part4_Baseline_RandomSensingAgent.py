"""
Part 4 Submission - RandomSensingAgent
Baseline RBC agent: random sensing, Stockfish majority-vote moves.
Run from RBC/solution:
    rc-bot-match RandomSensingAgent.py <other_bot.py>
"""
import os
import random
...
class RandomSensingAgent(Player):
    ...
    def choose_sense(self, sense_actions: Sequence[Square], move_actions: Sequence[chess.Move], seconds_left: float) -> Optional[Square]:
        ...
        return random.choice(non_edge if non_edge else list(sense_actions))
